...
const displayImages = async (
  ...
  try {
    ...
    if (!(await cacheChecker(filename, width, height))) {
      ...
      res.write(
        '<p style="color: green; font-size: 16px;">Image Resized Successfully</p><img style="display: block; margin-left: auto; margin-right: auto;" src="data:imageFile/jpeg;base64,'
      );
